CREATE OR REPLACE VIEW public.community_summary
AS SELECT applications.id AS application_id,
    ...
    applications.program_venue,
    applications.means_of_transportation,
    applications.source_of_income,
    applications.source_of_water,
    applications.distance,
    applications.geo_type,
    communities.total_graduates,
    ...
    sg_summary_upd.prevail_attend AS sg_prevail_attend_all,
